      ...
      <div className="bg-[#f4f5f6] color-[#000] border-b-[#e8e8e8] h-[60px] z-9">
        <div className="flex justify-between items-center lg:w-[1200px] sm:w-[390px] lg:m-auto sm:mx-[15px] h-[60px] text-[14px]">
          <div className="leading-[4px] sm:relative">
            <img className="lg:w-[175px] h-[40px] sm:w-[33%] sm:h-auto sm:pl-[px]" src={Logo} alt="" />
          </div>
          <div className="lg:flex p-[0px 12px] font-bold tracking-normal">
            <button data-collapse-toggle="navbar-default" type="button" className="sm:text-[#A8964E] sm:font-extrabold  sm:absolute sm:inline-flex sm:right-2 items-center p-0 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
